...
public class ViewCustomerJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewCustomerJPanel(JPanel userProcessContainer, Customer customer, CustomerDirectory customerDir, UserAccount account) {
        initComponents();
    ...
    public void populateField() {
        ...
        comboAge.setEnabled(false);
        comboSex.setEnabled(false);
        profilePic.setIcon(customer.getImgIcon());
    ...
    private void initComponents() {
        ...
        btnChooseImg.setText("Choose an image");
        ...
        lblCustomername1.setText("View Customer");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btnChooseImg, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (Utilities.isTextFieldEmpty(txtFirstName.getText()) || Utilities.isTextFieldEmpty(txtLastname.getText())
            ...
            if (cSearch == null || cSearch==customer) {
               customer.setFirstName(txtFirstName.getText());
                customer.setLastName(txtLastname.getText());
                customer.setAge((int) comboAge.getSelectedItem());
                customer.setSex(String.valueOf(comboSex.getSelectedItem()));
                customer.setMobileNumber(Long.parseLong(txtMobile.getText()));
                customer.setEmailId(txtEmail.getText());
                customer.getUserAccount().setUserName(txtUsername.getText());
                ...
                //profile image
                customer.setImgIcon((ImageIcon) profilePic.getIcon());
                ...
                btnUpdate.setEnabled(true);
                    ...
                    JOptionPane.showMessageDialog(null, "Someone has already used this userId");
            }
    ...
    private javax.swing.JComboBox<Integer> comboAge;
