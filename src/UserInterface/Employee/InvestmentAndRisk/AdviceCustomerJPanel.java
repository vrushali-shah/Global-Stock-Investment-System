 ...
 */
public class AdviceCustomerJPanel extends javax.swing.JPanel {
     ...
     */
    public AdviceCustomerJPanel(JPanel adviceCustContainer, CustomerDirectory customerDir, Organisation organisation, UserAccount account) {
        initComponents();
    ...
    private void btnServeCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnServeCustomerActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (awr.getReceiver() == null) {
                int reply = JOptionPane.showConfirmDialog(null, "Assign this reques to you and procced?", "Question", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                if (reply == 0) {
                    awr.setReceiver(account);
                } else {
                    return;
            ...
            ProcessAdviceJPanel panel = new ProcessAdviceJPanel(adviceCustContainer, awr);
